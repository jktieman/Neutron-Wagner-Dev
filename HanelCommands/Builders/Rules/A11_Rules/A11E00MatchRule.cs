...
namespace HanelCommands.Builders.Rules.A11_Rules
{
    /// <summary>
    /// Command was executed
    /// </summary>
    internal class A11E00MatchRule : IMatchRule
    {
                ...
                if (commandSegments[0].Length >= MinCommandSegmentsLength)
                {
                    ...
                    if (int.TryParse(lift, out int liftNumber))
                    {
                        ...
                        if (device != null)
                        {
                            ...
                            device.StatusMessage = $"Status Message -XA A11 E00 Command was Executed  Lift: {lift}";
                        }
                    }
                }
            }
