...
{
    public class XR_E12Command : IHanelCommand
    {
        ...
        /// <summary>
        /// Query for the Current Tray in the Access Point
        /// </summary>
        /// <param name="dataIn"></param>
        public XR_E12Command(byte[] dataIn)
        {
            _dataIn = dataIn;
        ...
        public XR_E12Command(string lift, string accessPoint)
        {
        ...
        public string HostSubCommand => "E12";
        public string Command => $"{AST}G{Lift}{AccessPoint}$M XR$E12${CR}{LF}";
        ...
        public string CommandExecuted => $"{AST}G{Lift}{AccessPoint}$P XA$A12$E00$T{Tray}${CR}{LF}";
