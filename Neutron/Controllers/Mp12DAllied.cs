...
namespace Neutron.Controllers
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is responsible for managing the interactions with the Mp12D device
    /// , including initialization, status checking, and handling notifications.
    /// </remarks>
    public class Mp12DAllied : IHanelDriver
    {
        ...
        public Mp12DAllied(Form frm, WorkstationView workstationView, IDialogService dialogService)
        {
        ...
        public Mp12DAllied(Form frm, WorkstationView workstationView, IDialogService dialogService , IDynamicLogger logger)
        {
            _previousTray = new int[10];
            _workstationView = workstationView ?? throw new ArgumentNullException(nameof(workstationView));
        ...
        {
            _hanel = _testing ? new Hanel_DeviceController(Hanel_DeviceController.Controller_Type_Hanel_Mp12D(), _dialogService, _logger, true) : new Hanel_DeviceController(Hanel_DeviceController.Controller_Type_Hanel_Mp12D(), _dialogService);
        }
