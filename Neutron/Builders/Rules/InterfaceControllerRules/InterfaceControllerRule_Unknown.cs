...
namespace IPTI_Tester.Builders.Rules.InterfaceControllerRules
{
    class InterfaceControllerRule_Unknown : IInterfaceControllerRule
    {
        ...
        {
            return new RuleResult(response) {Message = $"Unknown Interface Controller Rule Error.  {response}"};
        }
