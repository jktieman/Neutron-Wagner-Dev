...
{
    public class BayControllerRule_07 : IBayControllerRule
    {
        ...
        public ResponseInfo BuildInfo(Command currentCommand, string request, string response)
        {
            ...
            sb.AppendLine($"");
            sb.AppendLine($"Turn All Lights Off - Broadcast");
            sb.AppendLine($"Action Code: 07");
            sb.AppendLine();
            ...
            sb.AppendLine($"this command will cause a broadcast to all light picks and the 4-digits will not go off.");
            sb.AppendLine($"");
            sb.AppendLine($"Initiated By: PC");
            sb.AppendLine($"Bay Controller Version: 4.0 or greater");
            sb.AppendLine();
            sb.AppendLine($"Format of packet: 07");
            sb.AppendLine($"07 = Literal \"07\" - Action code for the Turn All Lights Off Broadcast command");
            sb.AppendLine();
            sb.AppendLine($"Response from bay controller: 07<ACK>");
            sb.AppendLine($"07 = Literal \"07\" - Action code for the Turn All Lights Off Broadcast command");
            sb.AppendLine($"");
