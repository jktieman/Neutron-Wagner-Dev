...
namespace Neutron.Builders.Rules.BayControllerRules
{
    public class BayControllerRule_01 : IBayControllerRule
    {
        ...
        public void BuildInfo(string response, ResponseInfo responseInfo)
        {
            ...
            {
                var cmd =
                    $"{responseInfo.ControllerNumber}{responseInfo.Command}{responseInfo.DisplayNumber}{Models.Global.ACK}";
                responseInfo.RespondCommand = Models.Global.SOH + cmd + cmd.GetCheckDigit() +
                                              Models.Global.ETX;
                int qty;
