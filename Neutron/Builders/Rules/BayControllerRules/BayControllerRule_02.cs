...
{
    public class BayControllerRule_02 : IBayControllerRule
    {
        ...
        public ResponseInfo BuildInfo(Command currentCommand, string request, string response)
        {
            ...
            sb.AppendLine($"");
            sb.AppendLine($"Turn All On With Verify");
            ...
            sb.AppendLine($"02 = Literal \"02\" - Action Code for ");
            sb.AppendLine();
            sb.AppendLine($"Response from bay controller: 02XXYY..<ACK>");
            sb.AppendLine($"02 = Literal \"02\" - Action code for Turn All On With Verify");
            sb.AppendLine($"XX,YY = Devices that did not come on. If more modules failed than what the bay");
            ...
            sb.AppendLine($"");
            sb.AppendLine($"024DXXYY..LPxxyy<ACK>");
            sb.AppendLine($"");
            sb.AppendLine($"02 = Literal \"02\" - Action code for Turn All On With Verify");
