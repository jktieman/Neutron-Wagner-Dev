...
{
    public partial class FrmReplenPickViewAdjustment : Form
    {
        private readonly ReplenPickView _pickView;
        public bool Success;
        ...
        /// </remarks>
        public FrmReplenPickViewAdjustment(ReplenPickView pickView)
        {
            InitializeComponent();
