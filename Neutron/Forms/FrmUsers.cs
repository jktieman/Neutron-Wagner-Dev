...
namespace Neutron.Forms
{
    public partial class FrmUsers : MetroForm
    {
        ...
        private GenericRepository<User> repoUser = new GenericRepository<User>(new NeutronDb());
        ...
        {
            int idx = 0;
            //IEnumerable<User> recs = repoUser.AllInclude(h => h.HomeLocation, h => h.Group, h => h.LocationGroup);
            //IEnumerable<UserView> projection = recs.Select(r => new UserView
            //{ Id = r.Id, EmpId = r.EmpId, Firstname = r.Firstname, Lastname = r.Lastname, Username = r.Username
            //, Pin = r.Pin.ToString(), Disabled = r.Disabled, HomeLocation = r.HomeLocation.Slot, GroupName = r.Group.Name
            //, LocationGroupName = r.LocationGroup.Name  
            //}).OrderBy(o => o.Lastname)
            //.ToList();

            IEnumerable<User> recs = repoUser.All();
            IEnumerable<UserView> projection = recs.Select(r => new UserView
            {
                Id = r.Id
            , EmpId = r.EmpId
        ...
        private void SetupGrid()
        {
            ...
            col.DataPropertyName = "EmpId";
            col.HeaderText = "Emp Id";
            ...
            col = new DataGridViewTextBoxColumn();
            col.DataPropertyName = "HomeLocation";
            col.HeaderText = "Home Location";
            col.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            //col.Width = Convert.ToInt32(w * .8);
            col.Name = "HomeLocation";
            col.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            DataGridView1.Columns.Add(col);

            col = new DataGridViewTextBoxColumn();
            col.DataPropertyName = "GroupName";
            col.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            col = new DataGridViewTextBoxColumn();
            col.DataPropertyName = "LocationGroupName";
            col.HeaderText = "LAC Group";
            col.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            //col.Width = Convert.ToInt32(w * 2.5);
            col.Name = "LocationGroupName";
