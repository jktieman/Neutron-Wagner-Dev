...
namespace Neutron.Forms
{
    public partial class FrmUtilities : MetroForm
    {
        ...
        private void Init()
        {
            ...
            Mediator.GetInstance().IsClientConnected += FrmUtilities_IsClientConnected;
        }
        ...
        private void MBOptions_Click(object sender, EventArgs e)
        {
            ...
            CheckBoxAutoLoadReplenishments.Checked = _neutronVariables.AutoLoadReplenishments;
        ...
        private void SavePrinterSettings()
        {
            ...
            if (!CheckBoxUseLoftwareFile.Checked) return;
            {
                ...
                try
                {
                    _jsonData.SaveFile<LoftwarePrinterPreferences>(LoftwareLabelPrinter);
                }
                catch (Exception ex)
                {
                    MessageBox.Show(
                        $"Error Saving Loftware Label Printer Information.  {ex.Message} {Environment.NewLine} {ex.InnerException}");
                }
            }
        }
        ...
        public void LoadLabelPrinterPreferences()
        {
            ...
            LoftwareLabelPrinter = _jsonData.LoadFile<LoftwarePrinterPreferences>();
            ...
            CheckBoxUseLoftwareFile.Checked = LoftwareLabelPrinter.UseLoftwareFile;
            TextBoxLoftwareFilePath.Text = LoftwareLabelPrinter.LoftwareFilePath;
            TextBoxLoftwarePrinter.Text = LoftwareLabelPrinter.LoftwarePrinter;
            TextBoxLoftwareStation.Text = LoftwareLabelPrinter.LoftwareStation;
        }
        ...
        private void ButtonPrintTestDocument_Click(object sender, EventArgs e)
        {
            ...
            if (printer != null)
            {
                ...
                if (!string.IsNullOrEmpty(order))
                {
                    ...
                    if (ord != null)
                    {
                        var pickList = GetPickList(ord.Id);
                        _documentToPrint.PrintPickList(pickList, printer, _neutronVariables.PrintPreview);
        ...
        private void ButtonPrintTestToteLabel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ord != null)
                {
                    ...
                    if (CheckBoxUseLoftwareFile.Checked)
                    {
                        ...
                        var desc = orderDetail.PartDesc.Trim();
        ...
        private void MBBatchLightTester_Click(object sender, EventArgs e)
        {
            ...
            {
                ButtonTurnOnBlastzoneDisplay.Enabled = true;
        ...
        private void CheckBoxUseLoftwareFile_CheckedChanged(object sender, EventArgs e)
        {
            // if checked show GroupBoxLoftwareInformaton
            GroupBoxLoftwareInformation.Visible = CheckBoxUseLoftwareFile.Checked;
        }
        ...
        private void ButtonPrintBarCode_Click(object sender, EventArgs e)
        {
            ...
            var pickSlips = GetPickSlipData(ord.Id);
        ...
        private void DrawTaskNoSection(Graphics g, ref int yValue)
        {
            ...
            g.DrawString("Task No:", new Font("arial", 10, FontStyle.Bold), new SolidBrush(Color.Black), 50, 185);
            g.DrawString("1345330", new Font("arial", 10, FontStyle.Bold), new SolidBrush(Color.Black), 150, 185);
        ...
        private void DrawShippingInstructions(Graphics g, ref int yValue)
        {
            ...
            yValue += RowHeight;
            g.DrawLine(Pens.Black, new Point(50, yValue), new Point(lineLength, yValue));
        ...
        private void DrawBody(Graphics g, ref int yValue)
        {
            ...
            for (var i = 0; (i < _adjustedNumRowsPerPage) && ((i + _printedRows) < _transferRecs.Count); i++)
            {
                ...
                else
                {
                    ...
                    var barcodeImage = GetBarcodeImage(rec.Item.Trim(), RowHeight - 5);
                    g.DrawImage(barcodeImage, xValue, yValue);
                    xValue += _bodyColumnWidths[1] + HeaderPadding;
                }
                ...
                if (_leftSide)
                {
                    ...
                    g.DrawString(rec.Ordered, _bodyFont, Brushes.Black, rect, formatCenter);
                    xValue += _bodyColumnWidths[4] + HeaderPadding;
                }
                else
                {
                    var barcodeImage = GetBarcodeImage(rec.Ordered, RowHeight - 5);
                    g.DrawImage(barcodeImage, xValue, yValue);
                    xValue += _bodyColumnWidths[4] + HeaderPadding;
                }
        ...
        private Image GetBarcodeImage(string text, int height)
        {
            ...
            Image barcodeImage = barcode.Draw(text, height, 1);
            return barcodeImage;
        ...
        private List<string> GetShippingInstructions(string input)
        {
            ...
            string wrappedText = output.ToString();
