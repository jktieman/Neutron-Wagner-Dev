...
namespace Neutron.Global
{
    public interface IHistoryManager
    {
        ...
        void SaveHistory(ActionCode actionCode, Order value, int stationId);
        void SaveHistory(ActionCode actionCode, OrderDetail value, int stationId);
        ...
        void SaveHistory(ActionCode actionCode, ReplenOrderDetail value, int stationId);
        void SaveHistory(ActionCode actionCode, ReplenOrder order, int stationId);
