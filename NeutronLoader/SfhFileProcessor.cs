...
namespace NeutronLoader
{
    public class SfhFileProcessor : IFileProcessor
    {
        ...
        public void LoadFiles(List<FileInfo> files)
        {
         ...
         _ = _logger.LogDetailAsync($"SFHFileProcessor --- Done");
        }
                ...
                switch (lineType)
                {
                    ...
                    case "2":
                        ...
                        else
                        {
                         ...
                         _ = _logger.LogDetailAsync($"Station Id: {itemDef.AreaId}");
            ...
            for (var i = 0; i < allLines.Length; i++)
            {
                ...
                switch (lineType)
                {
                    ...
                    case "2":
                        ...
                        replenDetail.AreaId = itemDef.AreaId;
        ...
        //    try
        //    {
        //        var station = _repoWorkstation.FindBy(r => r.Id == workstationId).FirstOrDefault();

        //        if (station != null)
        //        {
        //         _ = _logger.LogDetailAsync($"Get Station Number: {station.StationNumber}  WorkstationId: {workstationId} ");
        ...
        //    }
        // _ = _logger.LogDetailAsync($"Get Station Number Return: {stationNum}  WorkstationId: {workstationId} ");
        //    return stationNum;
        //}
        ...
        private int GetStationId(int stationNumber)
        {
            ...
            try
            {
                var station = _repoWorkstation.FindBy(r => r.StationNumber == stationNumber).FirstOrDefault();
                if (station != null)
                {
