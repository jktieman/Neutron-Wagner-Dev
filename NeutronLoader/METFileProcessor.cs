...
{
    public class METFileProcessor : IFileProcessor
    {
        ...
        public METFileProcessor(NeutronVariables neutronVariables, NeutronLicense neutronLicense, IDynamicLogger logger,
