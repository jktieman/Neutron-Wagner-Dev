...
{
    public class IptiResponseManager
    {
        ...
        public IptiResponseManager(BlockingCollection<byte[]> responseBlockingCollection,
            BlockingCollection<byte[]> requestBlockingCollection, BlockingCollection<byte[]> receivedBlockingCollection)
        {
            ...
            _logger = NeutronCore.Global.Logger.SetupLogger("IptiResponseManager");
        }

        public void Start()
        {
            _ = _logger.LogDetailAsync("IptiResponseManager: Start");
            ...
            {
                _ = _logger.LogDetailAsync("IptiResponseManager: Cancelled");
                return;
            }
        }
