...
namespace IPTI.Builders.Rules.BayControllerRules
{
    public class BayControllerRule_27 : IBayControllerRule
    {
        ...
        public void BuildInfo(string response, ResponseInfo responseInfo)
        {
            ...
            {
                var cmd = $"{responseInfo.ControllerNumber}{responseInfo.Command}{responseInfo.DisplayNumber}{Global.ACK}";
                responseInfo.RespondCommand = (Global.SOH + cmd + cmd.GetCheckDigit() + Global.ETX);
                int qty;
            ...
            //sb.AppendLine($"");
            //sb.AppendLine($"Display Text on OC");
            //sb.AppendLine($"Action Code: 27");
            //sb.AppendLine();
