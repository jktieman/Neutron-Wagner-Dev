...
{
    public class ReplenListProcessor
    {
        ...
        public void PrintReplenListDocument(IList<PickList> recs, DocumentPrinterPreferences printer, bool printPreview = false)
        {
            _transferRecs = recs;
            if (recs.Count > 0)
            {
        ...
        private void DrawTitle(Graphics g, ref int yValue)
        {
            ...
            var measureString = "Replenishment List";
        ...
        private void DrawTitleDetail(Graphics g, ref int yValue)
        {
            ...
            xValue = 25;
            yValue += RowHeight;
            g.DrawString("", _headerFont, Brushes.Black, xValue, yValue);
            xValue = 140;
        ...
        private void DrawBody(Graphics g, int yValue)
        {
            ...
            for (var i = 0; (i < NumRowsPerPage) && ((i + _printedRows) < _transferRecs.Count); i++)
            {
                ...
                g.DrawString(rec.Area.ToString(), _bodyFont, Brushes.Black, rect, format);
