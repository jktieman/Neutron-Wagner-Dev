...
namespace NeutronDllu
{
    public class AnticipatedOutsProcessor
    {
        ...
        public void PrintAnticipatedOutsDocument(IList<AnticipatedOut> recs, DocumentPrinterPreferences printer, bool printPreview = false)
        {
            _transferRecs = recs;
            try
            {
        ...
        private void DrawTitle(Graphics g, ref int yValue)
        {
            ...
            var measureString = "Anticipated Outs Report";
