...
{
    public class PackingListProcessor_FR
    {
        ...
        private void DrawTitle(Graphics g, ref int yValue)
        {
            ...
            var measureString = $"B0RDEREAU D'EXPEDITION{_batchPosition}";
 ...
 yValue = 140;
            var xValue = 25;
            g.DrawString("Heure", _headerFont, Brushes.Black, xValue, yValue);
            ...
            yValue = 160;
            g.DrawString("Centre de Coût", _headerFont, Brushes.Black, xValue, yValue);
            g.DrawString(": " + _packingListHeader.CostCenter, _headerFont, Brushes.Black, (float)xValue + 115, yValue);
            g.DrawString("Réquisition", _headerFont, Brushes.Black, (float)xValue + 590, yValue);
            g.DrawString(": " + _packingListHeader.Order, _headerFont, Brushes.Black, (float)xValue + 680, yValue);
            yValue = 180;
            g.DrawString("Réceptionnaire", _headerFont, Brushes.Black, xValue, yValue);
            g.DrawString(": " + _packingListHeader.Recipient, _headerFont, Brushes.Black, (float)xValue + 115, yValue);
            g.DrawString("Département", _headerFont, Brushes.Black, (float)xValue + 590, yValue);
