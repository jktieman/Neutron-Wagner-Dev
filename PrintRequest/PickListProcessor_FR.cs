...
{
    public class PickListProcessor_FR
    {
        ...
        private void DrawTitle(Graphics g, ref int yValue)
        {
            ...
            var measureString = "Bordereau de Cueillette";
        ...
        private void DrawTitleDetail(Graphics g, ref int yValue)
        {
            ...
            xValue = 815;
            g.DrawString("Réquisition", _headerFont, Brushes.Black, xValue, yValue);
            xValue = 905;
            ...
            xValue = 815;
            g.DrawString("Département", _headerFont, Brushes.Black, xValue, yValue);
            xValue = 905;
